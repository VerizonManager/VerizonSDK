#
#  Be sure to run `pod spec lint VerizonSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "VerizonSDK"
  spec.version      = "1.0.0"
  spec.summary      = "VerizonSDK."
  ...
  spec.homepage     = "https://github.com/VerizonManager/VerizonSDK"
...
spec.license      = { :type => "Apache License, Version 2.0", :file => "FILE_LICENSE" }
  ...
  spec.source_files  = "VerizonFramework/*.{h,m}","JitsiMeet.framework/Headers/*.h"
